...
final class ContactController extends AbstractController
{
    ...
    public function index(Request $request, MailerInterface $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // je récupère les données pour les mettre dans data
            $data = $form->getData();
            ...
            // Je redirige l'utilisateur pour éviter qu'il ne renvoie le formulaire
            return $this->redirectToRoute('app_contact');
        }

        // Si le formulaire n'est pas soumis j'affiche la page
        //    et envoie le formulaire à Twig pour qu'il puisse l'afficher.
